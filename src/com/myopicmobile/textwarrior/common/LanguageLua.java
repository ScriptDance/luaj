...
public class LanguageLua extends Language {
	...
	private final static String globalTarget="_ENV|_G|assert|collectgarbage|dofile|error|findtable|getmetatable|ipairs|load|loadfile|loadstring|module|next|pairs|pcall|print|rawequal|rawget|rawlen|rawset|require|select|setmetatable|tointeger|tonumber|tostring|type|unpack|xpcall";
	...
	private final static String extFunctionTarget="activity|call|dump|each|enum|loadbitmap|loadlayout|new_env|set|task|thread";
